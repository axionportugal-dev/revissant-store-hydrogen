        ...
        <div className="absolute top-1/2 -translate-y-1/2 left-6 md:left-24 max-w-lg">
          <div className="bg-[#0F2445]/60 backdrop-blur-xl p-10 md:p-14 border-l-[6px] border-blue-200 text-white shadow-2xl animate-fade-in relative overflow-hidden rounded-none">
            ...
            <Link
              to="/catalog"
              prefetch="intent"
              className="inline-block whitespace-nowrap bg-white border border-revissant-dark text-revissant-dark px-8 py-3 text-xs font-bold uppercase tracking-[0.15em] hover:bg-revissant-dark hover:text-white transition-colors rounded-none relative z-10"
            >
              Shop Home
            </Link>
          </div>
